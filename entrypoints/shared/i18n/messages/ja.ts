    ...
    options: {
        ...
        dataRecovery: {
            backupFile: {
                ...
                description: "エクスポートされたバックアップには、設定、概要プロファイル、保存された会議セッション、トランスクリプト、チャット履歴、翻訳、概要が含まれています。クラウド同期が利用できない場合、またはポータブルな暗号化されたスナップショットが必要な場合に使用します。",
            ...
            deleteArchive: {
                ...
                syncedDescription: "このデバイス、接続されているクラウド プロバイダー、および他の同期デバイスから同期されたアーカイブを削除します。 OpenAI のセットアップ、環境設定、概要プロファイルはそのまま残ります。",
                localDescription: "保存されているすべての会議セッションをローカル ストレージから削除します。これにより、OpenAI のセットアップ、環境設定、概要プロファイルが保持されます。"
            },
            confirmDelete: {
