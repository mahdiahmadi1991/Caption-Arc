...
export const zhMessages = {
    ...
    options: {
        ...
        dataRecovery: {
            backupFile: {
                title: "加密备份文件",
                description: "导出的备份包含您的设置、摘要配置文件、保存的会议会话、记录、聊天历史记录、翻译和摘要。当云同步不可用或需要便携式加密快照时使用它。",
                export: "导出所有数据",
                import: "导入备份文件"
            },
            passphrase: {
            ...
            deleteArchive: {
                title: "删除已保存的存档",
                syncedDescription: "从此设备、连接的云提供商和其他同步设备中删除同步存档。您的 OpenAI 设置、首选项和摘要配置文件保持不变。",
                localDescription: "从本地存储中删除所有已保存的会议会话。这将保留您的 OpenAI 设置、首选项和摘要配置文件。"
            },
            confirmDelete: {
