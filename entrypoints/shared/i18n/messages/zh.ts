...
示例：\`优先给出简短 talking points，并在起草回答前先指出隐藏风险。\``,
        ...
        runtime: {
            ...
            cloudSync: {
                ...
                connecting: "正在连接云提供商...",
                connectingProvider: "正在开始 {provider} 登录...",
                connectHint: "应会打开一个安全的浏览器窗口。请在那里完成登录，然后返回这里。",
                connectSuccess: "{provider} 已连接。",
                connectSuccessHint: "后台保护可从下一次同步周期继续。",
                disconnecting: "正在断开云提供商的连接...",
                disconnectingProvider: "正在断开 {provider}...",
                disconnectHint: "移除云访问期间，本地归档仍保留在此设备上。",
                disconnectSuccess: "{provider} 已断开连接。",
                disconnectSuccessHint: "您的本地归档仍可在此设备上使用。",
                retrying: "正在重试云同步...",
                retryingProvider: "正在为 {provider} 排队新的同步尝试...",
                retryHint: "CaptionArc 将请求该提供商再次恢复后台同步。",
                retrySuccess: "新的同步尝试已加入队列。",
                retrySuccessHint: "该提供商将在下一次运行时于后台重试。",
                reconnecting: "正在刷新云提供商访问权限...",
                reconnectingProvider: "正在刷新 {provider} 的访问权限...",
                reconnectSuccess: "{provider} 访问权限已刷新。",
                resolvingChoice: "正在应用共享设置选项...",
                resolveChoiceHint: "下一次后台周期将从所选起点开始协调。",
                choiceSuccess: "共享设置选择已应用。",
                choiceSuccessHint: "云同步将从选定的共享设置基线继续。",
                refreshing: "正在检查最新云同步状态...",
                refreshHint: "正在读取队列健康状态、提供商检查点和最近的同步活动。",
                refreshSuccess: "云同步状态已刷新。",
                refreshSuccessHint: "最新的提供商状态和队列健康状态现在已显示在此页面上。"
            }
        }
    },
    history: {
