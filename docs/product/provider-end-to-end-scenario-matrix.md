...
| Session finalization and continuation/rejoin decisioning | Implemented | Implemented | Implemented | `entrypoints/content/platform-runtime.ts`, `entrypoints/background/history.ts` |
