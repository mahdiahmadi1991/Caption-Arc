...
This section describes product intent, business-facing capability boundaries, and user-facing scope.

- [overview.md](./overview.md)
- [use-cases.md](./use-cases.md)
- [business-capability-map.md](./business-capability-map.md)
- [user-journeys-and-jtbd.md](./user-journeys-and-jtbd.md)
- [feature-availability-matrix.md](./feature-availability-matrix.md)
- [provider-end-to-end-scenario-matrix.md](./provider-end-to-end-scenario-matrix.md)
- [data-boundary-and-trust-model.md](./data-boundary-and-trust-model.md)
