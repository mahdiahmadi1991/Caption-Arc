...
7. Verify browser-gated cloud sync behavior remains explicit on Firefox: Google Drive and OneDrive must stay visibly unavailable until the browser limitation is intentionally removed.
