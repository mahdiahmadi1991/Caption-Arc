...
| DXFER-004 | C-DXFER-001, C-DXFER-002 | backup portability excludes the device-local OpenAI API key and preserves portable archive retention on import | `tests/google-meet/data-transfer.contract.test.ts` | implemented |
